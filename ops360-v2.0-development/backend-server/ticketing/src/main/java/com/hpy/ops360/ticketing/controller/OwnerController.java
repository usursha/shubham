...
public class OwnerController {
	...
	@Loggable
	public ResponseEntity<List<OwnerDto>> getSubcallTypeListPortal(@RequestBody BroadCategoryDto broadCategoryDto) {
		return ResponseEntity.ok(ownerService.getSubcallTypeListPortal(broadCategoryDto.getCategory()));
	...
	@Loggable
	public ResponseEntity<SelectedCategoryDto> getBroadCategory(@RequestBody SubCallTypeDto subCallTypeDto)
	{
		return ResponseEntity.ok(ownerService.getBroadCategory(subCallTypeDto.getSubcallType(),subCallTypeDto.getTicketNumber(),subCallTypeDto.getAtmId()));
	}
